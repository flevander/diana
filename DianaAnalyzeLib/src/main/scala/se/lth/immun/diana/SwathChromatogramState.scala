...
object SwathChromatogramState {
	class Stats {
		...
		def calculate(
			...
			// Markov dists
			markovDists = SwathUtil.calculateMarkovDists(
									numChromatograms, 
									ratios, 
									targetRatioTable, 
									pcMaxWidth)
...
class SwathChromatogramState(
		...
		var binSize:Int 	= SwathUtil.DEFAULT_BIN_SIZE
) {
	import SwathChromatogramState._
